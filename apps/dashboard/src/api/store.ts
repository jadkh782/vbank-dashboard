...
export { DEFAULT_SETTINGS, MANUAL_ERROR_CATEGORIES } from '@vbank/shared'
export type { AppSettings, DisplayInfo, ManualError, ManualErrorCategory } from '@vbank/shared'
